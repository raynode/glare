module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const postId = await queryInterface.rawSelect(
      'Posts',
      {
        where: {
          stub: 'my-stub',
    ...
    const accountId = await queryInterface.rawSelect(
      'Accounts',
      {
        where: {
          amount: 100,
    ...
    const bookmark1Id = await queryInterface.rawSelect(
      'Bookmarks',
      {
        where: {
          name: 'Case insensitive UNIQUE constraints in Postgres',
    ...
    const bookmark2Id = await queryInterface.rawSelect(
      'Bookmarks',
      {
        where: {
          name: 'Testing with Jest: 15 Awesome Tips and Tricks',
