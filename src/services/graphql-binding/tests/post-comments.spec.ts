...
//   post: Post
// }
// const postQueries: Methods<Post> = {
...
//     const hits = await queries.findMany(where, order, offset, limit)
...
//     const user = await queries.findOne(where, order, offset, 1)
//     if (user) {
...
//       },
//     ]
//     schema = modelsToSchema([Testuser])
